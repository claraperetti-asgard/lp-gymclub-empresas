...
export default function HowItWorks() {
  return (
    <section id="como-funciona" className="py-24 text-gray-900 relative overflow-x-clip">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative p-8 rounded-3xl bg-white border border-gray-100 shadow-lg shadow-gray-100/50 hover:border-gray-200 transition-all"
            >
              ...
              <h3 className="text-xl font-bold mb-3 relative z-10 text-gray-900">{step.title}</h3>
              <p className="font-title font-light text-gray-600 relative z-10">{step.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
